    ...
    <div className="login-root">
      <div className="login-card">
        <div className="login-logo">
          <img src={logo} alt="Lunaris logo" />
          <span className="login-logo-text">Lunaris</span>
        </div>
        ...
        <p className="login-footer">
          By signing in you agree to the project&apos;s terms. Your data is only
          used to authenticate your identity via GitHub OAuth.
        </p>
      </div>
    </div>
  )
