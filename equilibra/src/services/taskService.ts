...
export const taskService = {
  ...
  reorderTasks: async (projectId: string | number, bucketId: number | string, taskIds: (number | string)[]): Promise<{ status: string; order: (number | string)[]; bucket_id: number | string }> => {
