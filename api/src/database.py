...
class DatabaseUser(BaseModel):
    # `id` is generated by the DB (identity); don't require it on POST
    id: Optional[int] = None
    display_name: Optional[str] = None
    # `created_at` has DB default now(); optional for input
    created_at: Optional[str] = None
    # required according to your SQL: telegram_chat_id NOT NULL
...
# Global connection pool (Threaded for FastAPI threads)
